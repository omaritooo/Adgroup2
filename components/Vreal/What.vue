<template>
    <div class="container flex justify-between mx-auto">
        <div class="py-[340px] flex flex-col mx-auto text-center gap-y-2">
            <h1
        ...
        <div class="relative z-30 max-w-[500px] my-auto">
            <client-only>
                <swiper class="swiper" :options="swiperOption">
                    ...
                    <div slot="pagination" class="mt-20 swiper-pagination"></div>
                </swiper>
            </client-only>
        </div>
    </div>
