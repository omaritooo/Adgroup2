<template>
    <div ref="canvasHolder" class="canvasHolder">
        ...
        <div class="text">AD GROUP INC.</div>
        <div class="subtext">Lorem ipsum dolor sit amet, consectetur adipiscing.</div>
    </div>
</template>
...
.canvas {
    ...
    pointer-events: all;
    z-index: 1;
    background: url("https://i.pinimg.com/originals/95/9f/b1/959fb1f51bc1026ace27acede55e1bc8.gif");
}
.text {
    color: white;
    font-size: 90px;
